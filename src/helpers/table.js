...
module.exports = {
    successTable({ kind, apiVersion, metadata, spec, status }) {
        ...
        rootLevel.push({ root: rootTable }, { status: statusTable }, { spec: specTable }, { metadata: metadataTable });
    ...
    secretSuccessTable({ kind, apiVersion, metadata, data, type, details }) {
        ...
        rootLevel.push({ root: rootTable }, { data: dataTable }, { metadata: metadataTable }, { details: detailsTable });
        const finalTable = rootLevel.toString();
        return finalTable;
    },
    serviceSuccessTable({ kind, apiVersion, metadata, spec, status }) {
        ...
        rootLevel.push({ root: rootTable }, { spec: specTable }, { selector: selectorTable }, { ports: portsTable }, { metadata: metadataTable });
        const finalTable = rootLevel.toString();
        return finalTable;
    },
    pvcSuccessTable({ kind, apiVersion, metadata, spec, status }) {
        ...
        rootLevel.push({ root: rootTable }, { spec: specTable }, { resource: resourceTable }, { selector: selectorTable }, { metadata: metadataTable });
        const finalTable = rootLevel.toString();
        return finalTable;
    },
    resourceQuotaTable({ kind, apiVersion, metadata, spec }) {
        ...
        rootLevel.push({ root: rootTable }, { spec: specTable }, { metadata: metadataTable });
        const finalTable = rootLevel.toString();
        return finalTable;
